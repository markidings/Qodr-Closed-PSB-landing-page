					...
					{{-- <div class="row text-capitalize"> --}}
						{{-- <div class="col-md-12"> --}}
							{{-- <div class="form-group"> --}}
								...
								<h3>Terima Kasih telah mempercayakan urusan catering Aqiqah anda dengan membeli di Akikah.com.
									Semoga Berkah bagi </h3> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<button onclick="var delay = 500; var url = '/etalase-paket'; setTimeout(function(){ window.location = url; }, delay); " id="tombol" class="success btn btn-primary btn-lg btn-block" >Ok</button> --}}
							{{-- </div>  --}}
						{{-- </div> --}}
					{{-- </div> --}}
				{{-- </div> --}}
...
@endsection
		...
		<script>
			$(document).ready(function(){
				Swal.fire({
					title: 'Terima Kasih',
					text: 'Telah mempercayakan urusan catering Aqiqah anda dengan membeli di Akikahkita.com. Semoga Berkah..',
					width: 600,
					padding: '3em',
					showClass: {
