    ...
    <div class="col-12"> 
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <a href="{{ route('purchase-confirms.create') }}" class="btn btn-sm btn-success mt-3"><i class="fas fa-plus"></i> Konfirmasi Pembayaran</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('purchase-confirms.edit', [
                                            'purchase_confirm' => $data->id
...
@push('js')
    ...
    <script>
        const BASE_DELETE_URL = '{{ route('purchase-confirms.index') }}';
