...
@section('content')
    <div class="row">  
        <div class="col-12"> 
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Transaksi Paket Mandiri</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @csrf
                                        ...
                                        <input name="status_transaction" type="hidden" value="offline mandiri" readonly/>
                                        <input type="hidden" name="type_payment" value="offline" readonly>
                                ...
                                @foreach ($pakets as $pakets)
                                    @if ($pakets->city_id == Auth::user()->city_id)
                                        ...
                                        <td><input type='radio' id="{{$pakets->harga}}" payment="{{$pakets->price}}" price="{{$pakets->harga}}" target="{{ $pakets->id }}" value='{{ $pakets->nama }}' name='selectPaket' required></td>
                                            <td><small>{{ $pakets->city->name}}</small></td>
