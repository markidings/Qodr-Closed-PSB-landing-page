                            ...
                            <tbody >
                                ...
                                @foreach ($bookings as $b)
                                    <tr class="text-capitalize"> 
                                        ...
                                        <td {!! $b->status_time_index !!}>{{ $b->packet->nama }}</td>
                ...
                var year = $("#yearNumber").val()
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            var myhtml = "";
                                myhtml += "<table class='table'><thead><tr><th scope='col'>No</th><th scope='col'>Nama Pemesan</th><th scope='col'>Nama Paket</th>"
                                myhtml += "<th scope='col'>No Nota</th><th scope='col'>No Whatsapp</th><th scope='col'>Aksi</th></tr></thead><tbody>"
