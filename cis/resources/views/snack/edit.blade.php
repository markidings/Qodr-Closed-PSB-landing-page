...
@section('title', 'Akikahkita | Edit Menu Tambahan')
@section('content-title', 'Edit Menu Tambahan')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img class="img-responsive" id="previewPhoto" src="{{ $snack->photo_url }}" style="height:200px;"/>
                                </div>
                            </div>
                        </div>
                    </div>
