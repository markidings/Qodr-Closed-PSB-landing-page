<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger">{{ $errors->first('office_photo') }}</span>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger">{{ $errors->first('kitchen_photo') }}</span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger">{{ $errors->first('shed_photo') }}</span>
