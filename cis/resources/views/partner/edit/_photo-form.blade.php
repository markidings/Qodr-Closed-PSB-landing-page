<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <img class="img-responsive" id="previewProfilePhoto" src="{{ $partner->meta->profile_photo_url }}" style="height:200px;"/>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger">{{ $errors->first('office_photo') }}</span><br>
            <img class="img-responsive" id="previewOfficePhoto" src="{{ $partner->meta->office_photo_url }}" style="height:200px;"/>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger">{{ $errors->first('kitchen_photo') }}</span><br>
            <img class="img-responsive" id="previewKitchenPhoto" src="{{ $partner->meta->kitchen_photo_url }}" style="height:200px;"/>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="text-danger">{{ $errors->first('shed_photo') }}</span><br>
            <img class="img-responsive" id="previewShedPhoto" src="{{ $partner->meta->shed_photo_url }}" style="height:200px;"/>
        </div>
    </div>
</div>
