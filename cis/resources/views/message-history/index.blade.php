                    ...
                    <table id="messageTable" class="table">
                        ...
                        <tbody>
                            ...
                            @foreach ($messages as $message)
                                <tr>
                                    <td>{{ $no++ }}.</td>
                                    <td><input type="checkbox" name="userlist[]" id="user-checked" value="{{ $message->id }}"></td>
                                    <td>{{ $message->message }}</td>
                                    <td>{{ $message->phone_number }}</td>
                                    <td><span class="badge badge-info">{{ $message->type }}</span></td>
                                    <td><button class="btn btn-sm btn-circle btn-success" type="button" onclick="sendOne({{ $message->id }}, {{ $message->no_whatsapp }})"><i class="far fa-paper-plane"></i></button></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
