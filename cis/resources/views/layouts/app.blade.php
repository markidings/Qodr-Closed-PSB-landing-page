...
<head>
    ...
    <title>@yield('title', 'Akikah Kita | Login')</title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url({{ asset('images/big/akikah_logo.jpg') }}); background-color: #FFFFFF;background-repeat: no-repeat; background-size: 350px 350px;">
                </div>
