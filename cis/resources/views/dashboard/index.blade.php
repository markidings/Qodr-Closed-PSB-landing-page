...
@section('title', 'Akikah Kita | Dashboard')
@section('content')
                ...
                <div class="card-group">
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ $user }}</h2>
                                    @if (auth()->user()->isAdminCS() || auth()->user()->isAdminSystem())
                                        <a class="text-muted font-weight-normal mb-0 w-100 text-truncate" href="{{ route('partners.index') }}">Mitra</a>
                                    @else 
                                        <a class="text-muted font-weight-normal mb-0 w-100 text-truncate" href="#">Mitra</a>
                                    @endif
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class="fas fa-user" style="font-size:30px"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ $city }}</h2>
                                    @if (auth()->user()->isAdminCS() || auth()->user()->isAdminSystem())
                                        <a class="text-muted font-weight-normal mb-0 w-100 text-truncate" href="{{ route('cities.index') }}">Kota</a>
                                    @else 
                                        <a class="text-muted font-weight-normal mb-0 w-100 text-truncate" href="#">Kota</a>
                                    @endif
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class="fas fa-building" style="font-size:30px"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card border-right">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">{{ $customer }}</h2>
                                    @if (auth()->user()->isAdminCS() || auth()->user()->isAdminSystem())
                                        <a class="text-muted font-weight-normal mb-0 w-100 text-truncate" href="{{ route('report-client.index') }}">Pelanggan</a>
                                    @else 
                                        <a class="text-muted font-weight-normal mb-0 w-100 text-truncate" href="#">Pelanggan</a>
                                    @endif
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class="fas fa-users" style="font-size:30px"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <h2 class="text-dark mb-1 font-weight-medium">{{ $panding }}</h2>
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Leads</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-muted"><i class="fas fa-book" style="font-size:30px"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-style-none mb-0">
                                    <li>
                                        ...
                                        <span class="text-muted">Customer Lunas</span>
                                        <span class="text-dark float-right font-weight-medium">785</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-cyan font-10 mr-2"></i>
                                        <span class="text-muted">Customer DP</span>
                                        <span class="text-dark float-right font-weight-medium">1538</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-danger font-10 mr-2"></i>
                                        <span class="text-muted">Customer Gagal</span>
                                        <span class="text-dark float-right font-weight-medium">159</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-default font-10 mr-2"></i>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <h4 class="card-title mb-0">Statistik Financial</h4>
                                    <div class="ml-auto">
