        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card mb-3" id="show-el-modal">
                            <div class="card-body border-top">
                                ...
                                <div class="row">
                                    <div class="col-3 col-sm-3">
                                        <b class="font-weight-semi-bold mb-1">Nama Mitra</b>
                                    </div>
                                    <div class="col" id="nama-mitra"></div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-3 col-sm-3">
                                ...
                                <div class="col-12">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control select2-multiple select2-w-100 form-control-sm" required name="city_id" id="partner-option"><option value="">--Cari Kota--</option></select>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input
                                                    ...
                                                    id="harga-edit"
                                                    type="number"
                                                    placeholder="kosongkan harga jantan tidak perlu"
                                                    name="harga"
                                                    >
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input
                                                    ...
                                                    id="price-edit"
                                                    type="number"
                                                    placeholder="kosongkan harga betina jika tidak perlu"
                                                    name="price"
                                                    >
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input type="hidden" name="update" value="supdate" id="status-paket">
                                        </div>
                                </div>
                        </div>
                    </div> 
                ...
                <div class="modal-footer">
                    ...
                    <button id="update-btn" class="btn btn-sm btn-primary saveMe" type="submit">
